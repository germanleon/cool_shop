...
Cuando /^hago click en "([^\"]*)" dentro de "([^\"]*)"$/ do |link, parent|
...
Entonces /^el checkbox "([^\"]*)" debería estar marcado$/ do |label|
  Then %{the "#{label}" checkbox should be checked}
end

Entonces /^el checkbox "([^\"]*)" no debería estar marcadao/ do |label|
...
Entonces /^muéstrame la página$/ do
